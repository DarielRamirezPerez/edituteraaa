...
BOT_TOKEN = '6267837171:AAFS-VMb2qJfvLFVLA5BrYO5XA-LwbQnlUI' #Aqui va el token del bot
API_ID =24253609#
...
static_proxy = 'socks5h://KJHHJFZGJHMIGHZHKJLILHZIJHILGDRJEFMKHFML' #agrega si kieres tener un proxy statico Con @raydel0307 si kieres comprar un proxy
